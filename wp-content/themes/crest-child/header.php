...
<html <?php language_attributes();?>>
	<head>
		<!-- Google tag (gtag.js) -->
		<script async src="https://www.googletagmanager.com/gtag/js?id=G-6ELHCP7EV1"></script>
		<script>
		  window.dataLayer = window.dataLayer || [];
		  function gtag(){dataLayer.push(arguments);}
		  gtag('js', new Date());
		
		  gtag('config', 'G-6ELHCP7EV1');
		</script>
			...
			<h1>Canyon Crest Elementary School</h1>
				...
				<aside>
					<ul class="sociallinks">
						<li><a href="https://www.instagram.com/canyoncrest_cubs/"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-instagram-white.svg' ?>" alt="Link to Instagram" /></span>
							</a>
						</li>
